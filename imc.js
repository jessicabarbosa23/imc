function imc(){
    ...
    const paciente = {
        ...
        calcularIMC(){
            ...
            if (imc >= 40 &&  imc < 45 ) this.classificacao = "obesidade Severa"
    ...
    resposta.innerHTML="Seu IMC é "+paciente.calcularIMC()+". " + "Sua classificação de peso " + paciente.classificação;
}
